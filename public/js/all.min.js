...
if(o.trigger(r),e.trigger(s),!s.isDefaultPrevented()&&!r.isDefaultPrevented()){var a=t(i);this.activate(e.closest("li"),n),this.activate(a,a.parent(),function(){o.trigger({type:"hidden.bs.tab",relatedTarget:e[0]}),e.trigger({type:"shown.bs.tab",relatedTarget:o[0]})})}}},n.prototype.activate=function(e,i,o){function r(){s.removeClass("active").find("> .dropdown-menu > .active").removeClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!1),e.addClass("active").find('[data-toggle="tab"]').attr("aria-expanded",!0),a?(e[0].offsetWidth,e.addClass("in")):e.removeClass("fade"),e.parent(".dropdown-menu")&&e.closest("li.dropdown").addClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!0),o&&o()}var s=i.find("> .active"),a=o&&t.support.transition&&(s.length&&s.hasClass("fade")||!!i.find("> .fade").length);s.length&&a?s.one("bsTransitionEnd",r).emulateTransitionEnd(n.TRANSITION_DURATION):r(),s.removeClass("in")};var i=t.fn.tab;t.fn.tab=e,t.fn.tab.Constructor=n,t.fn.tab.noConflict=function(){return t.fn.tab=i,this};var o=function(n){n.preventDefault(),e.call(t(this),"show")};t(document).on("click.bs.tab.data-api",'[data-toggle="tab"]',o).on("click.bs.tab.data-api",'[data-toggle="pill"]',o)}(jQuery),+function(t){"use strict";function e(e){return this.each(function(){var i=t(this),o=i.data("bs.affix"),r="object"==typeof e&&e;o||i.data("bs.affix",o=new n(this,r)),"string"==typeof e&&o[e]()})}var n=function(e,i){this.options=t.extend({},n.DEFAULTS,i),this.$target=t(this.options.target).on("scroll.bs.affix.data-api",t.proxy(this.checkPosition,this)).on("click.bs.affix.data-api",t.proxy(this.checkPositionWithEventLoop,this)),this.$element=t(e),this.affixed=this.unpin=this.pinnedOffset=null,this.checkPosition()};n.VERSION="3.3.1",n.RESET="affix affix-top affix-bottom",n.DEFAULTS={offset:0,target:window},n.prototype.getState=function(t,e,n,i){var o=this.$target.scrollTop(),r=this.$element.offset(),s=this.$target.height();if(null!=n&&"top"==this.affixed)return n>o?"top":!1;if("bottom"==this.affixed)return null!=n?o+this.unpin<=r.top?!1:"bottom":t-i>=o+s?!1:"bottom";var a=null==this.affixed,l=a?o:r.top,c=a?s:e;return null!=n&&n>=l?"top":null!=i&&l+c>=t-i?"bottom":!1},n.prototype.getPinnedOffset=function(){if(this.pinnedOffset)return this.pinnedOffset;this.$element.removeClass(n.RESET).addClass("affix");var t=this.$target.scrollTop(),e=this.$element.offset();return this.pinnedOffset=e.top-t},n.prototype.checkPositionWithEventLoop=function(){setTimeout(t.proxy(this.checkPosition,this),1)},n.prototype.checkPosition=function(){if(this.$element.is(":visible")){var e=this.$element.height(),i=this.options.offset,o=i.top,r=i.bottom,s=t("body").height();"object"!=typeof i&&(r=o=i),"function"==typeof o&&(o=i.top(this.$element)),"function"==typeof r&&(r=i.bottom(this.$element));var a=this.getState(s,e,o,r);if(this.affixed!=a){null!=this.unpin&&this.$element.css("top","");var l="affix"+(a?"-"+a:""),c=t.Event(l+".bs.affix");if(this.$element.trigger(c),c.isDefaultPrevented())return;this.affixed=a,this.unpin="bottom"==a?this.getPinnedOffset():null,this.$element.removeClass(n.RESET).addClass(l).trigger(l.replace("affix","affixed")+".bs.affix")}"bottom"==a&&this.$element.offset({top:s-e-r})}};var i=t.fn.affix;t.fn.affix=e,t.fn.affix.Constructor=n,t.fn.affix.noConflict=function(){return t.fn.affix=i,this},t(window).on("load",function(){t('[data-spy="affix"]').each(function(){var n=t(this),i=n.data();i.offset=i.offset||{},null!=i.offsetBottom&&(i.offset.bottom=i.offsetBottom),null!=i.offsetTop&&(i.offset.top=i.offsetTop),e.call(n,i)})})}(jQuery),function(t,e){var n=t();t.fn.dropdownHover=function(i){return"ontouchstart"in document?this:(n=n.add(this.parent()),this.each(function(){function o(){n.find(":focus").blur(),p.instantlyCloseOthers===!0&&n.removeClass("open"),e.clearTimeout(r),a.addClass("open"),s.trigger(u)}var r,s=t(this),a=s.parent(),l={delay:500,instantlyCloseOthers:!0},c={delay:t(this).data("delay"),instantlyCloseOthers:t(this).data("close-others")},u="show.bs.dropdown",d="hide.bs.dropdown",p=t.extend(!0,{},l,i,c);a.hover(function(t){return a.hasClass("open")||s.is(t.target)?void o(t):!0},function(){r=e.setTimeout(function(){a.removeClass("open"),s.trigger(d)},p.delay)}),s.hover(function(t){return a.hasClass("open")||a.is(t.target)?void o(t):!0}),a.find(".dropdown-submenu").each(function(){var n,i=t(this);i.hover(function(){e.clearTimeout(n),i.children(".dropdown-menu").show(),i.siblings().children(".dropdown-menu").hide()},function(){var t=i.children(".dropdown-menu");n=e.setTimeout(function(){t.hide()},p.delay)})})}))},t(document).ready(function(){t('[data-hover="dropdown"]').dropdownHover()})}(jQuery,this),!function(t){"function"==typeof define&&define.amd?define(["jquery"],t):t(jQuery)}(function(t){function e(e){var n={},i=/^jQuery\d+$/;return t.each(e.attributes,function(t,e){e.specified&&!i.test(e.name)&&(n[e.name]=e.value)}),n}function n(e,n){var i=this,r=t(i);if(i.value==r.attr("placeholder")&&r.hasClass(p.customClass))if(r.data("placeholder-password")){if(r=r.hide().nextAll('input[type="password"]:first').show().attr("id",r.removeAttr("id").data("placeholder-id")),e===!0)return r[0].value=n;r.focus()}else i.value="",r.removeClass(p.customClass),i==o()&&i.select()}function i(){var i,o=this,r=t(o),s=this.id;if(""===o.value){if("password"===o.type){if(!r.data("placeholder-textinput")){try{i=r.clone().attr({type:"text"})}catch(a){i=t("<input>").attr(t.extend(e(this),{type:"text"}))}i.removeAttr("name").data({"placeholder-password":r,"placeholder-id":s}).bind("focus.placeholder",n),r.data({"placeholder-textinput":i,"placeholder-id":s}).before(i)}r=r.removeAttr("id").hide().prevAll('input[type="text"]:first').attr("id",s).show()}r.addClass(p.customClass),r[0].value=r.attr("placeholder")}else r.removeClass(p.customClass)}function o(){try{return document.activeElement}catch(t){}}var r,s,a="[object OperaMini]"==Object.prototype.toString.call(window.operamini),l="placeholder"in document.createElement("input")&&!a,c="placeholder"in document.createElement("textarea")&&!a,u=t.valHooks,d=t.propHooks;if(l&&c)s=t.fn.placeholder=function(){return this},s.input=s.textarea=!0;else{var p={};s=t.fn.placeholder=function(e){var o={customClass:"placeholder"};p=t.extend({},o,e);var r=this;return r.filter((l?"textarea":":input")+"[placeholder]").not("."+p.customClass).bind({"focus.placeholder":n,"blur.placeholder":i}).data("placeholder-enabled",!0).trigger("blur.placeholder"),r},s.input=l,s.textarea=c,r={get:function(e){var n=t(e),i=n.data("placeholder-password");return i?i[0].value:n.data("placeholder-enabled")&&n.hasClass("placeholder")?"":e.value},set:function(e,r){var s=t(e),a=s.data("placeholder-password");return a?a[0].value=r:s.data("placeholder-enabled")?(""===r?(e.value=r,e!=o()&&i.call(e)):s.hasClass(p.customClass)?n.call(e,!0,r)||(e.value=r):e.value=r,s):e.value=r}},l||(u.input=r,d.value=r),c||(u.textarea=r,d.value=r),t(function(){t(document).delegate("form","submit.placeholder",function(){var e=t("."+p.customClass,this).each(n);setTimeout(function(){e.each(i)},10)})}),t(window).bind("beforeunload.placeholder",function(){t("."+p.customClass).each(function(){this.value=""})})}}),function(t){t.jscroll={defaults:{debug:!1,autoTrigger:!0,autoTriggerUntil:!1,loadingHtml:"<small>Loading...</small>",padding:0,nextSelector:"a:last",contentSelector:"",pagingSelector:"",callback:!1}};var e=function(e,n){function i(){var e=t(h.loadingHtml).filter("img").attr("src");if(e){var n=new Image;n.src=e}}function o(){e.find(".jscroll-inner").length||e.contents().wrapAll('<div class="jscroll-inner" />')}function r(t){if(h.pagingSelector)var e=t.closest(h.pagingSelector).hide();else{var e=t.parent().not(".jscroll-inner,.jscroll-added").addClass("jscroll-next-parent").hide();e.length||t.wrap('<div class="jscroll-next-parent" />').parent().hide()}}function s(){return b.unbind(".jscroll").removeData("jscroll").find(".jscroll-inner").children().unwrap().filter(".jscroll-added").children().unwrap()}function a(){o();var t=e.find("div.jscroll-inner").first(),n=e.data("jscroll"),i=parseInt(e.css("borderTopWidth")),r=isNaN(i)?0:i,s=parseInt(e.css("paddingTop"))+r,a=g?b.scrollTop():e.offset().top,l=t.length?t.offset().top:0,c=Math.ceil(a-l+b.height()+s);return!n.waiting&&c+h.padding>=t.outerHeight()?(d("info","jScroll:",t.outerHeight()-c,"from bottom. Loading next request..."),u()):void 0}function l(t){return t=t||e.data("jscroll"),t&&t.nextHref?(c(),!0):(d("warn","jScroll: nextSelector not found - destroying"),s(),!1)}function c(){var t=e.find(h.nextSelector).first();h.autoTrigger&&(h.autoTriggerUntil===!1||h.autoTriggerUntil>0)?(r(t),y.height()<=v.height()&&a(),b.unbind(".jscroll").bind("scroll.jscroll",function(){return a()}),h.autoTriggerUntil>0&&h.autoTriggerUntil--):(b.unbind(".jscroll"),t.bind("click.jscroll",function(){return r(t),u(),!1}))}function u(){var n=e.find("div.jscroll-inner").first(),i=e.data("jscroll");return i.waiting=!0,n.append('<div class="jscroll-added" />').children(".jscroll-added").last().html('<div class="jscroll-loading">'+h.loadingHtml+"</div>"),e.animate({scrollTop:n.outerHeight()},0,function(){n.find("div.jscroll-added").last().load(i.nextHref,function(n,o){if("error"===o)return s();var r=t(this).find(h.nextSelector).first();i.waiting=!1,i.nextHref=r.attr("href")?t.trim(r.attr("href")+" "+h.contentSelector):!1,t(".jscroll-next-parent",e).remove(),l(),h.callback&&h.callback.call(this),d("dir",i)})})}function d(t){if(h.debug&&"object"==typeof console&&("object"==typeof t||"function"==typeof console[t]))if("object"==typeof t){var e=[];for(var n in t)"function"==typeof console[n]?(e=t[n].length?t[n]:[t[n]],console[n].apply(console,e)):console.log.apply(console,e)}else console[t].apply(console,Array.prototype.slice.call(arguments,1))}var p=e.data("jscroll"),f="function"==typeof n?{callback:n}:n,h=t.extend({},t.jscroll.defaults,f,p||{}),g="visible"===e.css("overflow-y"),m=e.find(h.nextSelector).first(),v=t(window),y=t("body"),b=g?v:e,x=t.trim(m.attr("href")+" "+h.contentSelector);return e.data("jscroll",t.extend({},p,{initialized:!0,waiting:!1,nextHref:x})),o(),i(),c(),t.extend(e.jscroll,{destroy:s}),e};t.fn.jscroll=function(n){return this.each(function(){var i=t(this),o=i.data("jscroll");if(!o||!o.initialized){new e(i,n)}})}}(jQuery);var statusObject={ajaxSetup:function(){"use strict";$.ajaxSetup({headers:{"X-CSRF-Token":$('input[name="_token"]').val()}})},deleteStatus:function(t){"use strict";$(document).on("click",t,function(t){t.preventDefault();var e=confirm("Are you sure?");if(e){var n=$(this).attr("id");statusObject.deleteStatusAjax("#"+n)}})},deleteStatusAjax:function(t){"use strict";var e=$(t).attr("action"),n=$('input[name="_token"]').val();$.ajax({url:e,type:"POST",dataType:"json",data:{_method:"DELETE",_token:n},success:function(t){t.success&&location.reload()},error:function(t){console.log(t)}})},postStatus:function(t){"use strict";$(document).on("click",t,function(t){t.preventDefault(),statusObject.postStatusAjax("#post-status-form")})},postStatusAjax:function(t){"use strict";var e=$(t).attr("action"),n=$("#post-status-textarea").val(),i=$('input[name="_token"]').val(),o=$('input[name="userId"]').val();$.ajax({url:e,type:"POST",dataType:"json",data:{userId:o,body:n,_token:i},success:function(e){e.success&&($(t)[0].reset(),location.reload())},error:function(t){console.log(t)}})},postComment:function(t){"use strict";$(document).on("keydown",t,function(t){var e=t.keyCode?t.keyCode:t.which;if(13==e){t.preventDefault();var n=$(this).attr("id"),i=n.split("-"),o=i[0];statusObject.postCommentAjax("#"+n,n,o)}})},postCommentAjax:function(t,e,n){"use strict";var i=$(t).attr("action"),o=$("#post-comment-textarea-"+e).val(),r=$('input[name="_token"]').val();$.ajax({url:i,type:"POST",dataType:"json",data:{status_id:n,body:o,_token:r},success:function(e){e.success&&($(t)[0].reset(),location.reload())},error:function(t){console.log(t)}})},alertShowHide:function(t){var e=$(t).find(".alert-info");e.length>0&&($(e).hide(),$(e).fadeIn(500,function(){$(this).show(),setTimeout(function(){$(e).fadeOut(500,function(){$(this).hide()})},1500)}))}},systemObject={addPressedToHomeIcon:function(t){"/statuses"===window.location.pathname&&$(t).addClass("navbar-home-icon-pressed")}};$(function(){statusObject.ajaxSetup(),statusObject.deleteStatus(".delete-status"),statusObject.postStatus("#post-status"),statusObject.postComment(".comments_create-form"),statusObject.alertShowHide("body"),$("#flash-overlay-modal").modal(),systemObject.addPressedToHomeIcon(".navbar-home-icon-box")});